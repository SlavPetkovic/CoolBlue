...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.button_up = customtkinter.CTkButton(self.sidebar_frame, command=self.sidebar_button_event)
        self.button_up.grid(row=1, column=0, padx=20, pady=10)
        self.button_down = customtkinter.CTkButton(self.sidebar_frame, command=self.sidebar_button_event)
        self.button_down.grid(row=2, column=0, padx=20, pady=10)
        ...
        # set default values
        self.button_up.configure(text="Forward")
